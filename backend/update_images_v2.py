"""Update image URLs to use placeholder.com."""
...
def update_images():
    ...
    try:
        ...
        for dest_id, name in destinations:
            ...
            ), {"url": f"https://via.placeholder.com/800x600/{color}/FFFFFF?text={name.replace(' ', '+')}", "id": dest_id})
        ...
        for act_id, title in activities:
            ...
            for i in range(3):
                ...
                """), {
                    "url": f"https://via.placeholder.com/800x600/{color}/FFFFFF?text=Image+{i+1}",
                    "act_id": act_id,
                    "idx": i
                })
