...
export default function Footer() {
  ...
  return (
    <footer className="bg-ink text-cream border-t border-cream/[0.08]">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/cancellation" className="text-gray-400 hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/vendor/register" className="text-gray-400 hover:text-primary transition-colors">
                  {getTranslation('page.list_experience')}
                </Link>
              </li>
              <li>
                <Link href="/vendor/login" className="text-gray-400 hover:text-primary transition-colors">
                  {getTranslation('page.vendor_login')}
                </Link>
              </li>
              <li>
                <Link href="/vendor/dashboard" className="text-gray-400 hover:text-primary transition-colors">
                  {getTranslation('page.vendor_dashboard')}
                </Link>
              </li>
              <li>
                <Link href="/affiliate" className="text-gray-400 hover:text-primary transition-colors">
            ...
            <div>
              ...
              <form className="flex">
                <input
                  ...
                  className="bg-paper text-white px-4 py-2 rounded-l flex-1 outline-none focus:ring-2 focus:ring-primary"
                />
        ...
        <div className="border-t border-cream/[0.08] mt-8 pt-8">
