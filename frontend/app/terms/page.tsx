          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                By accessing and using FinuoTravel (the "Platform"), you accept and agree to be bound by
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                not with FinuoTravel. We act as an intermediary to facilitate the booking.
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                FinuoTravel is not liable for any indirect, incidental, or consequential damages arising
