  ...
  const pressReleases = [
    {
      ...
      title: 'FinuoTravel Reaches 10 Million Happy Travelers',
    ...
    },
    {
      ...
      title: 'FinuoTravel Launches Enhanced Vendor Dashboard',
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-paper rounded-lg shadow-lg p-8 mb-12">
          ...
          <p className="text-gray-600 mb-6">
            FinuoTravel has been featured in leading travel and technology publications worldwide
          </p>
